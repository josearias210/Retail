...
{
    public class RabbitProduceMessage<TMessage, TResult> : IDisposable
    {
        ...
        public RabbitProduceMessage(RabbitMQSettings settings, ISerializer serializer, string queueName)
        {
        ...
        public MessageResult<TResult> Send(MessageRequest message)
        {
